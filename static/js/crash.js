...
function load_crash(){
    ...
    maincontainer[0].style.height = imageHeight + 'px';
    container = document.getElementById("container-crash");

    TweenMax.set(container, {perspective:500});
    image = new Image();
    image.src = '/static/js/img/santa-claus.jpg';
...
Fragment.prototype = {
    ...
    createCanvas:function() {
        ...
        this.canvas.className = "canvas_crash";
    ...
    clip:function() {
        ...
        this.ctx.closePath();
        this.ctx.clip();
        this.ctx.drawImage(image, 0, 0, imageWidth, imageHeight-50);
    }
};